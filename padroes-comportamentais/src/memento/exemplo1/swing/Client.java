package memento.exemplo1.swing;

import memento.exemplo1.swing.component.TextAreaWithMemory;
import memento.exemplo1.swing.memory.Caretaker;
import memento.exemplo1.swing.component.TextAreaWithMemory.TextAreaMemento;
...
public class Client {
	...
	public static void main(String[] args) {
		...
		mementosList.addItemListener(e -> {
			originator.restore((TextAreaMemento) caretaker.getIndex(mementosList.getSelectedIndex()));
			originator.requestFocusInWindow();
		});
		...
		next.addActionListener(e -> {
			if (mementosList.getSelectedIndex() < mementosList.getItemCount() - 1) {
				...
				originator.restore((TextAreaMemento) caretaker.getIndex(nextItem));
		...
		previous.addActionListener(e -> {
			if (mementosList.getSelectedIndex() > 0) {
				...
				originator.restore((TextAreaMemento) caretaker.getIndex(previousItem));
